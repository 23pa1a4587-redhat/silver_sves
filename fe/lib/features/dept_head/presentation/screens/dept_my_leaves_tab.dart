...
import '../../../employee/presentation/providers/employee_leave_provider.dart';
import '../../../employee/presentation/screens/apply_leave_dialog.dart';
import '../../../profile/presentation/providers/user_leave_provider.dart';

/// Department Head's personal leaves tab - Apply and view their own leaves
class DeptMyLeavesTab extends ConsumerStatefulWidget {
  const DeptMyLeavesTab({super.key});

  @override
  ConsumerState<DeptMyLeavesTab> createState() => _DeptMyLeavesTabState();
}

class _DeptMyLeavesTabState extends ConsumerState<DeptMyLeavesTab> {
