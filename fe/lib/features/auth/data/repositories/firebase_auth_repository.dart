...
class FirebaseAuthRepository implements AuthRepository {
  ...
  Future<UserModel> signInWithEmailPassword({
    ...
    try {
      ...
      // STEP 1: Look up user in auth lookup table (users collection) by email
  ...
  // ============================================================
  // Phone/OTP Authentication (Commented out - using email auth)
  // ============================================================
  /*
  @override
  ...
  */
  ...
  Future<UserModel?> getCurrentUser() async {
    try {
      ...
      // STEP 1: Look up user in auth lookup table by email
      final authLookupSnapshot = await _firestore
          .collection(FirebaseConstants.usersCollection)
