...
class _DepartmentsTabState extends ConsumerState<DepartmentsTab> {
  ...
  Widget build(BuildContext context) {
    final departmentsAsync = ref.watch(
      departmentsProvider(activeOnly: false), // Show all departments
    );

    return Scaffold(
      backgroundColor: AppColors.background,
      appBar: AppBar(title: const Text('Departments'), elevation: 0),
      ...
      body: departmentsAsync.when(
        data: (departments) {
          // Sort: Active departments first, then inactive
          ...
          return RefreshIndicator(
            ...
            child: ListView(
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text(
                        '${sortedDepartments.length} ${sortedDepartments.length == 1 ? 'Department' : 'Departments'}',
                ...
                // Department List (sorted: active first, then inactive)
